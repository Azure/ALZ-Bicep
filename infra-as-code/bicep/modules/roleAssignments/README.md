...
- [Parameter details for Azure Commercial Cloud](roleAssignmentManagementGroup.bicep.md)

### roleAssignmentManagementGroupMany.bicep

- [Parameter details for Azure Commercial Cloud](roleAssignmentManagementGroupMany.bicep.md)

### roleAssignmentSubscription.bicep

- [Parameter details for Azure Commercial Cloud](roleAssignmentSubscription.bicep.md)

### roleAssignmentSubscriptionMany.bicep

- [Parameter details for Azure Commercial Cloud](roleAssignmentSubscriptionMany.bicep.md)
