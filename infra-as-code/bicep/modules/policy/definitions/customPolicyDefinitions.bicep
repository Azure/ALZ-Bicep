...
var varCustomPolicyDefinitionsArray = [
  ...
  {
    name: 'Audit-AKS-kubenet'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_Audit-AKS-kubenet.json')
  }
  {
...
var varCustomPolicySetDefinitionsArray = [
	...
	{
		name: 'Enforce-Guardrails-KeyVault_20260203'
		libSetDefinition: loadJsonContent('lib/policy_set_definitions/policy_set_definition_es_Enforce-Guardrails-KeyVault_20260203.json')
		libSetChildDefinitions: [
			{
				...
				definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsKeyVault_20260203Parameters['Deny-keyVaultManagedHsm-RSA-Keys-without-MinKeySize'].parameters
				definitionGroups: []
				definitionVersion: '1.*.*-preview'
			}
			{
				...
				definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsKeyVault_20260203Parameters['Deny-Kv-Cert-Expiration-Within-Specific-Number-Days'].parameters
				definitionGroups: []
				definitionVersion: '2.*.*'
			}
			{
				...
				definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsKeyVault_20260203Parameters['Deny-KV-Cert-Period'].parameters
				definitionGroups: []
				definitionVersion: '2.*.*'
			}
			{
				...
				definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsKeyVault_20260203Parameters['Deny-KV-Cryptographic-Type'].parameters
				definitionGroups: []
				definitionVersion: '1.*.*'
			}
			{
				...
				definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsKeyVault_20260203Parameters['Deny-KV-Curve-Names'].parameters
				definitionGroups: []
				definitionVersion: '1.*.*'
			}
			{
				...
				definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsKeyVault_20260203Parameters['Deny-KV-Elliptic-Curve'].parameters
				definitionGroups: []
				definitionVersion: '2.*.*'
			}
			{
				...
				definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsKeyVault_20260203Parameters['Deny-Kv-Hsm-Curve-Names'].parameters
				definitionGroups: []
				definitionVersion: '1.*.*-preview'
			}
			{
				definitionReferenceId: 'Deny-KV-Hsm-Key-Expire'
				definitionId: '/providers/Microsoft.Authorization/policyDefinitions/1d478a74-21ba-4b9f-9d8f-8e6fced0eec5'
				definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsKeyVault_20260203Parameters['Deny-KV-Hsm-Key-Expire'].parameters
				definitionGroups: []
				definitionVersion: '1.*.*-preview'
			}
			{
				...
				definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsKeyVault_20260203Parameters['Deny-Kv-Hsm-MinimumDays-Before-Expiration'].parameters
				definitionGroups: []
				definitionVersion: '1.*.*-preview'
			}
			{
				definitionReferenceId: 'Deny-KV-Hsm-PurgeProtection'
				definitionId: '/providers/Microsoft.Authorization/policyDefinitions/c39ba22d-4428-4149-b981-70acb31fc383'
				definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsKeyVault_20260203Parameters['Deny-KV-Hsm-PurgeProtection'].parameters
				definitionGroups: []
				definitionVersion: '1.*.*'
			}
			{
				...
				definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsKeyVault_20260203Parameters['Deny-Kv-Integrated-Ca'].parameters
				definitionGroups: []
				definitionVersion: '2.*.*'
			}
			{
				...
				definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsKeyVault_20260203Parameters['Deny-KV-Key-Active'].parameters
				definitionGroups: []
				definitionVersion: '1.*.*'
			}
			{
				...
				definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsKeyVault_20260203Parameters['Deny-KV-Key-Types'].parameters
				definitionGroups: []
				definitionVersion: '2.*.*'
			}
			{
				...
				definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsKeyVault_20260203Parameters['Deny-KV-Keys-Expire'].parameters
				definitionGroups: []
				definitionVersion: '1.*.*'
			}
			{
				...
				definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsKeyVault_20260203Parameters['Deny-Kv-Non-Integrated-Ca'].parameters
				definitionGroups: []
				definitionVersion: '2.*.*'
			}
			{
				...
				definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsKeyVault_20260203Parameters['Deny-KV-RSA-Keys-without-MinCertSize'].parameters
				definitionGroups: []
				definitionVersion: '2.*.*'
			}
			{
				...
				definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsKeyVault_20260203Parameters['Deny-KV-RSA-Keys-without-MinKeySize'].parameters
				definitionGroups: []
				definitionVersion: '1.*.*'
			}
			{
				...
				definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsKeyVault_20260203Parameters['Deny-KV-Secret-ActiveDays'].parameters
				definitionGroups: []
				definitionVersion: '1.*.*'
			}
			{
				...
				definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsKeyVault_20260203Parameters['Deny-Kv-Secret-Content-Type'].parameters
				definitionGroups: []
				definitionVersion: '1.*.*'
			}
			{
				...
				definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsKeyVault_20260203Parameters['Deny-KV-Secrets-ValidityDays'].parameters
				definitionGroups: []
				definitionVersion: '1.*.*'
			}
			{
				...
				definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsKeyVault_20260203Parameters['Deny-KV-without-ArmRbac'].parameters
				definitionGroups: []
				definitionVersion: '1.*.*'
			}
			{
				...
				definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsKeyVault_20260203Parameters.KvCertLifetime.parameters
				definitionGroups: []
				definitionVersion: '2.*.*'
			}
			{
				...
				definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsKeyVault_20260203Parameters.KvFirewallEnabled.parameters
				definitionGroups: []
				definitionVersion: '3.*.*'
			}
			{
				...
				definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsKeyVault_20260203Parameters.KvKeysExpire.parameters
				definitionGroups: []
				definitionVersion: '1.*.*'
			}
			{
				...
				definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsKeyVault_20260203Parameters.KvKeysLifetime.parameters
				definitionGroups: []
				definitionVersion: '1.*.*'
			}
			{
				...
				definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsKeyVault_20260203Parameters.KvPurgeProtection.parameters
				definitionGroups: []
				definitionVersion: '2.*.*'
			}
			{
				...
				definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsKeyVault_20260203Parameters.KvSecretsExpire.parameters
				definitionGroups: []
				definitionVersion: '1.*.*'
			}
			{
				...
				definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsKeyVault_20260203Parameters.KvSecretsLifetime.parameters
				definitionGroups: []
				definitionVersion: '1.*.*'
			}
			{
				...
				definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsKeyVault_20260203Parameters.KvSoftDelete.parameters
				definitionGroups: []
				definitionVersion: '3.*.*'
			}
		]
	...
	}
	{
		...
		libSetChildDefinitions: [
			{
				definitionReferenceId: 'Audit-AKS-Kubenet'
				definitionId: '${varTargetManagementGroupResourceId}/providers/Microsoft.Authorization/policyDefinitions/Audit-AKS-kubenet'
				definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsKubernetesParameters['Audit-AKS-Kubenet'].parameters
				definitionGroups: []
				definitionVersion: '1.*.*'
			}
			{
	...
	}
	{
		...
		libSetChildDefinitions: [
			...
			{
				definitionReferenceId: 'Deny-Sql-Entra-Required'
				definitionId: '/providers/Microsoft.Authorization/policyDefinitions/b3a22bc9-66de-45fb-98fa-00f5df42f41a'
				definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsSQLParameters['Deny-Sql-Entra-Required'].parameters
				definitionGroups: []
				definitionVersion: '1.*.*'
			}
			{
			...
			{
				definitionReferenceId: 'Deny-Sql-Managed-Entra-Required'
				definitionId: '/providers/Microsoft.Authorization/policyDefinitions/0c28c3fb-c244-42d5-a9bf-f35f2999577b'
				definitionParameters: varPolicySetDefinitionEsEnforceGuardrailsSQLParameters['Deny-Sql-Managed-Entra-Required'].parameters
				definitionGroups: []
				definitionVersion: '1.*.*'
			}
			{
...
// var varPolicySetDefinitionEsEnforceEncryptTransitParameters = loadJsonContent('lib/policy_set_definitions/policy_set_definition_es_Enforce-EncryptTransit.parameters.json') // Deprecated from ALZ - superseded by dated versions and missing definitionVersion on built-in policy references which risks breaking changes
...
var varPolicySetDefinitionEsEnforceGuardrailsKeyVault_20260203Parameters = loadJsonContent('lib/policy_set_definitions/policy_set_definition_es_Enforce-Guardrails-KeyVault_20260203.parameters.json')
