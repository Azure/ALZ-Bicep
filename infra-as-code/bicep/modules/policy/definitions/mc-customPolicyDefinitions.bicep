  ...
  }
  {
    ...
    libSetChildDefinitions: [
      ...
      }
      {
        ...
        definitionParameters: json(loadTextContent('lib/china/policy_set_definitions/policy_set_definition_es_mc_deploy_diagnostics_loganalytics.parameters.json')).AVDHostPoolsDeployDiagnosticLogDeployLogAnalytics.parameters
      }
      {
        ...
        definitionParameters: json(loadTextContent('lib/china/policy_set_definitions/policy_set_definition_es_mc_deploy_diagnostics_loganalytics.parameters.json')).BastionDeployDiagnosticLogDeployLogAnalytics.parameters
      }
      {
