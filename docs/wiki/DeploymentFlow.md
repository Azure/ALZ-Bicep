...
The following modules can be used to deploy components representing different scenarios according to the Azure Landing Zone conceptual architecture.

### Scenario: On-premises connectivity using Azure vWAN
...
|   2   | VNet Peering with vWAN                        | Connect a virtual network to a Virtual WAN hub.                                                                                          | Management Groups, Subscription for spoke VNet, vWAN Connectivity Module                    | [TBD](https://github.com/Azure/ALZ-Bicep/tree/main/infra-as-code/bicep/modules/vnetPeeringvWAN)                             |
