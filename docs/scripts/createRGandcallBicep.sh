...
az deployment group create --template-file infra-as-code/bicep/modules/containerRegistry/containerRegistry.bicep  --resource-group $azureResourceGroup --name deployACR
