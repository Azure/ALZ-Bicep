...
The module requires the following inputs:
 ...
 | parSubnets                      | array  | See example parameters file [`parameters/hubNetworking.parameters.all.json`](parameters/hubNetworking.parameters.all.json) | The name and IP address range for each subnet in the virtual networks.                                                                                                                                                                                                              | Must provide array of objects | See Default                                    |
