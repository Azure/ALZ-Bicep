...
The module requires the following inputs:
 ...
 | parSubnets                   | array  | See example parameters file [`hubNetworking.parameters.json`](hubNetworking.parameters.example.json) | Array of objects to providing for dynamic set of subnets                                                                                                                                                                                                            | Must provide array of objects | See Default                  |
