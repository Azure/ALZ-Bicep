...
The module requires the following inputs:
 ...
 | parGatewayAvailabilityZones  | array  | Empty Array []                                                                                                             | Availability Zones to deploy the Gateway across. Region must support Availability Zones to use. If it does not then leave empty.                                                                                                                                | None                          | `['1']` or `['1' ,'2', '3']`                   |
