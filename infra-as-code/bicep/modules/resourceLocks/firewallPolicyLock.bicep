metadata name = 'ALZ Bicep - Azure Firewall Policy Lock creation module'
metadata description = 'Module used to create a resource lock for Azure Firewall Policy'
