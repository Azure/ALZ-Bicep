...
The module requires the following inputs:
 ...
 | parSubnets                        | array  | See example parameters file [`hubNetworking.parameters.all.json`](parameters/hubNetworking.parameters.all.json) | Array of objects to provide for a dynamic set of subnets                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Must provide array of objects | See Default                                    |
 ...
 | parBgpRoutePropagationDisabled     | bool   | false                                                                                                | Switch which allows BGP Propagation to be disabled on the route tables                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | None                          | false                                          |
