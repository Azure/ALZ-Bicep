metadata name = 'ALZ Bicep - DDoS Protection Plan Lock creation module'
metadata description = 'Module used to create a resource lock for DDoS Protection Plan'
...
resource ddosProtectionPlan 'Microsoft.Network/ddosProtectionPlans@2023-05-01' existing = {
