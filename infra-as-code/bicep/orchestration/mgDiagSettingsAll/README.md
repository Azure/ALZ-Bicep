...
| parTopLevelManagementGroupSuffix      | string | Suffix for the management group hierarchy.  This suffix will be added to management group names created as part of the deployment.                                                                         | 1-10 characters                   | `-suffix`                                                                                   |
