metadata name = 'ALZ Bicep - Virtual Network Gateway Lock creation module'
metadata description = 'Module used to create a resource lock for Virtual Network Gateways'
...
resource virtualNetworkGateway 'Microsoft.Network/virtualNetworkGateways@2023-02-01' existing = {
