...
- Utilize the [ALZ Bicep Accelerator and associated documentation](https://github.com/Azure/ALZ-Bicep/accelerator/README.md), which will configure a development framework and incorporate production ready CI/CD pipelines
