metadata name = 'ALZ Bicep - Bastion Lock creation module'
metadata description = 'Module used to create a resource lock for Bastion'
...
resource bastionHosts 'Microsoft.Network/bastionHosts@2023-05-01' existing = {
