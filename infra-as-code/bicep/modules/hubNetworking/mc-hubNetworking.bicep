...
@description('Array of DNS Zones to provision in Hub Virtual Network. Default: All known Azure Privatezones in Azure China according to https://docs.microsoft.com/en-us/azure/private-link/private-endpoint-dns#china and a few more private DNS zone names not listed in the Azure docs web page')
