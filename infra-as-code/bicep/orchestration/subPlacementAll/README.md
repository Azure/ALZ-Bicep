...
The module requires the following inputs:
 ...
 | parTopLevelManagementGroupSuffix        | string | `''`    | Suffix for the management group hierarchy                                                                                                                                 | No      | `'-suffix'`                                                                           |
 ...
 | parLandingZoneMgChildrenSubs            | object | `{}`    | Dictionary Object to allow additional or different child Management Groups of the Landing Zones Management Group describing the subscriptions which each of them contain. | No       | [See below](#parlandingzonemgchildrensubs-and-parplatformmgchildrensubs-input-examples)                          |
  | parPlatformMgChildrenSubs            | object | `{}`    | Dictionary Object to allow additional or different child Management Groups of the Platform Management Group describing the subscriptions which each of them contain. | No       | [See below](#parlandingzonemgchildrensubs-and-parplatformmgchildrensubs-input-examples)                          |
