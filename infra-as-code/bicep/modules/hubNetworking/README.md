...
The module requires the following inputs:
 ...
 | parAzGatewayAvailabilityZones  | array  | Empty Array []                                                                                                             | Availability Zones to deploy the Gateway PIP across. Ensure that you use a zonal SKU for the Gateway if using Zonal or Zone-Redundant Public IP Address. Region must support Availability Zones to use. If it does not then leave empty.                                                                                                                                | None                          | `['1']` or `['1' ,'2', '3']`                   |
