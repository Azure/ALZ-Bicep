...
The module requires the following inputs:
 ...
 | parGatewayAvailabilityZones  | array  | Empty Array []                                                                                                             | Availability Zones to deploy the Gateway across. Region must support Availability Zones to use. If it does not then leave empty. Ensure that if you select availability zones with the gateway deployment that you choose a zonal SKU for the gateway config object                                                                                                                           | None                          | `['1']` or `['1' ,'2', '3']`                   |
