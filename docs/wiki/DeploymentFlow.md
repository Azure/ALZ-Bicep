...
|   2   | Custom Policy Definitions              | Configures Custom Policy Definitions at the `organization management group`, including preview CloudHealth health-model definitions.                                                                  | Management Groups.                                                     | [infra-as-code/bicep/modules/policy/definitions](https://github.com/Azure/ALZ-Bicep/tree/main/infra-as-code/bicep/modules/policy/definitions)                                   |
...
|   8   | Built-In and Custom Policy Assignments | Creates policy assignments for governance at scale, including preview CloudHealth health-model policies in AzureCloud.                                                                                | Management Groups, Log Analytics Workspace & Custom Policy Definitions | [infra-as-code/bicep/modules/policy/assignments/alzDefaults](https://github.com/Azure/ALZ-Bicep/tree/main/infra-as-code/bicep/modules/policy/assignments/alzDefaults)           |
...
> [!NOTE]
> AzureCloud ALZ defaults enable the preview CloudHealth health-model policies. Step 2 deploys
> their definitions. Step 8 assigns them at Platform and Landing Zones scope. After an upgrade,
> remediation can deploy health models to existing subscriptions under those scopes. The
> remediation identity receives Contributor and Role Based Access Control Administrator, so it
> can write and delete role assignments.
