...
resource resSpokeVirtualNetwork 'Microsoft.Network/virtualNetworks@2022-05-01' = {
...
resource resSpokeToHubRouteTable 'Microsoft.Network/routeTables@2022-05-01' = if (!empty(parNextHopIpAddress)) {
