...
#
# PowerShell Script
# - Update template library in alz-bicep repository
#
...
$esltConfig += $policyDefinitionFilePaths | ForEach-Object {
    [PsCustomObject]@{
        ...
        fileNamePrefix = "lib/policy_definitions/policy_definition_es_"
    }
}
...
$esltConfig += $policySetDefinitionFilePaths | ForEach-Object {
    [PsCustomObject]@{
        ...
        fileNamePrefix = "lib/policy_set_definitions/policy_set_definition_es_"
        fileNameSuffix = ".json"
    }
}
...
# $policyDefinitionFiles = Get-ChildItem -Path "$TargetModulePath/infra-as-code/bicep/modules/policy/policy-definitions/lib/"
...
# $policySetDefinitionFiles = Get-ChildItem -Path "$TargetModulePath/infra-as-code/bicep/modules/policy/policy-set-definitions/lib/"
